...
(function(exports) {
  ...
  var ToggleModal = (function () {
      function ToggleModal(value0) {
          this.value0 = value0;
      };
      ToggleModal.create = function (value0) {
          return new ToggleModal(value0);
      };
      return ToggleModal;
  })();
  ...
  var buttonClasses = "ba b--blue bg-blue bw0 f5 hover-bg-dark-blue outline-0 pa3 pointer white";
  var someArbitraryViewFunction = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("flex flex-column items-center justify-center pa6")) ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text(state.message) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName(buttonClasses)), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ToggleModal.create)) ])([ Halogen_HTML_Core.text("Close") ]) ]);
  };
  var modal = (function () {
  ...
  exports["modal"] = modal;
  exports["theModal"] = theModal;
  exports["buttonClasses"] = buttonClasses;
  exports["someArbitraryViewFunction"] = someArbitraryViewFunction;
})(PS["Modal"] = PS["Modal"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Modal.modal)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
